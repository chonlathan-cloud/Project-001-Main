...
Cloud Run services, 30-day operational retention, the severity-bounded sink,
the resource-bounded view, destinations, exact view IAM and the existing
Product Audit boundary before a deployment can start.
