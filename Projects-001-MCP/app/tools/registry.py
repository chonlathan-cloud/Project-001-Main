...
TOOLS = (
    ...
    _tool("list_inspection_items", DomainName.INSPECTION, "project_operations", project=True),
    _tool("get_inspection_item", DomainName.INSPECTION, "project_operations", project=True),
    _tool("list_daily_reports", DomainName.DAILY_REPORTS, "project_operations", project=True),
    _tool("get_daily_report", DomainName.DAILY_REPORTS, "project_operations", project=True),
    _tool(
    ...
    _tool("get_report_share_status", DomainName.DAILY_REPORTS, "project_operations", project=True),
    _tool("search_documents", DomainName.GCS_FILES, "finance_documents", project=True),
    _tool("get_document_metadata", DomainName.GCS_FILES, "finance_documents", project=True),
    _tool(
